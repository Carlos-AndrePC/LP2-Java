...
class Alfabeto{
    public static void main(String[] args){
        ...
        try{
            ...
            System.err.println("Erro na frase");
        }
        while (line != "") // Enquando houver linhas a serem lidas
        { 
            ...
            System.out.println("Se quiser ver denovo digeite qualquer coisa se nao Enter: ");
            try{
                line  = inData.readLine();
            } catch( IOException e){
                System.err.println("Erro na frase");
